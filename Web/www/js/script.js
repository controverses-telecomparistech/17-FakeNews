...
(function(){
	...
	function setSlideNav(){
		jQuery(".toggleDrawer").click(function(e){
			//alert($Home.css('marginRight'));
			e.preventDefault();

			if($Home.css('marginLeft')=='0px'){
				$drawerRight.animate({marginRight : 0},500);
				$Home.animate({marginLeft : -300},500);
			}
			else{
	...
	jQuery('#scrollToContent').click(function(e){
		e.preventDefault();
		jQuery.scrollTo("#Introduction", 1000, { offset:-(jQuery('#header .top').height()), axis:'y' });
	});
